# Support for Output Descriptors in Rtidcoin Core

Since Rtidcoin Core v2.0.0, there is support for Output Descriptors in the
...
- P2SH addresses (base58, of the form `3...` for mainnet or `2...` for testnet).
- Segwit addresses (bech32, of the form `bc1...` for mainnet or `tb1...` for testnet).
...
on Rtidcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Rtidcoin Core wallets, a convenience function `combo` is
