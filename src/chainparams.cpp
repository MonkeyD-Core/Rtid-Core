...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("pool.rtidcoin.io");   // Official pool node
        vSeeds.emplace_back("pool.luckypool.org"); // Luckypool node
        vSeeds.emplace_back("eu.rtidcoin.org");    // EU node
        vSeeds.emplace_back("us.rtidcoin.org");    // USA node
        vSeeds.emplace_back("asia.rtidcoin.org");  // Asia node
        vSeeds.emplace_back("ru.rtidcoin.org");    // Russia node
        vSeeds.emplace_back("seed.rtidcoin.org");  // Cryptomorpher
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet.rtidcoin.io");
