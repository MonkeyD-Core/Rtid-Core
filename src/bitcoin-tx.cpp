...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " rtidcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  rtidcoin-tx [options] <hex-tx> [commands]  Update hex-encoded rtidcoin transaction\n" +
            "or:     rtidcoin-tx [options] -create [commands]   Create hex-encoded rtidcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rtidcoin transaction
